...
@section('body')
    <div class="bg-blue-50 flex justify-center items-center h-screen">
        <form action="/login" method="post" class="w-4/5 lg:w-2/12">
            ...
            <input type="email" name="email" id="email" placeholder="Masukkan email..." value="{{ Session::get('email') }}" required class="bg-transparent border-b border-slate-300 mb-4 p-1 w-full"><br>
            ...
            <input type="password" name="password" id="password" placeholder="Masukkan password..." required class="bg-transparent border-b border-slate-300 mb-4 p-1 w-full"><br>
